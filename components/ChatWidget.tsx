...
const ChatWidget: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
      {/* Chat Window */}
      {isOpen && (
        <div className="bg-white rounded-2xl shadow-2xl w-[90vw] sm:w-96 h-[500px] mb-4 flex flex-col border border-gray-200 overflow-hidden">
          {/* Header */}
          <div className="bg-primary-800 p-4 flex justify-between items-center text-white">
